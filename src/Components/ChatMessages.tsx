...
interface ChatMessagesPorps extends HTMLAttributes<HTMLDivElement> {}

const ChatMessages: FC<ChatMessagesPorps> = ({ className, ...props }) => {
  const { messages } = useContext(MessagesContext);
  const inverseMessage = [...messages].reverse();
  return (
    <div
      {...props}
      className={cn(
